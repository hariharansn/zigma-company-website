                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6" id='about' >
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="fade-up">
                        ...
                        <div className="flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">CORE STRENGTHS</h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>The Zigma Technologies showing the right way to build technology for your enterprise. New technologies paves way to the betterment of the business and conveniently it helps to manage the right way. As of our dedicated team of professional always ensures the integrate the best on the client satisfaction and an extra step for the perfection.</p>
                            </div>
